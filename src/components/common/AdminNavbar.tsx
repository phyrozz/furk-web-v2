...
const AdminNavbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 py-4 bg-white ${
        scrolled
          ? 'shadow-md'
          : ''
      }`}
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 font-medium text-gray-700 hover:text-primary-500 transition-colors w-full text-left"
              >
                <LogOut size={20} />
                <span>Logout</span>
              </button>
